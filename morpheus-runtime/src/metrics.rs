...
impl MorpheusMetrics {
    ...
    pub fn record_ack_latency(&self, worker_id: u32, latency_ns: u64) {
        ...
        let worker_samples = samples.entry(worker_id).or_insert_with(Vec::new);
    ...
    pub fn render(&self) -> String {
        ...
        // Hint counts
        output.push_str("# HELP morpheus_hint_count_total Total hints received by worker and reason\n");
        ...
        // Hint drops
        output.push_str("# HELP morpheus_hint_drops_total Total hints dropped due to ring buffer overflow\n");
        ...
        output.push_str("# HELP morpheus_defensive_mode_total Defensive mode activations by worker\n");
        ...
        output.push_str("# HELP morpheus_last_ack_latency_seconds Hint acknowledgment latency in seconds\n");
